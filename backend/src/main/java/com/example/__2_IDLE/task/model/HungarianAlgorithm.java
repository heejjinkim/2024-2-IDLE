...
public class HungarianAlgorithm {
    ...
    /**
     * Check if all columns are covered. If that's the case then the      * optimal solution is
     * found
     *
    ...
    /**
     * Step 1: Reduce the matrix so that in each row and column at least one zero exists: 1.
     * subtract each row minima from each element of the row 2. subtract each column minima from

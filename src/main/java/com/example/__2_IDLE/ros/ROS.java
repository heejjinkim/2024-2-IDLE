...
public class ROS<T extends MessageValue> {
    ...
    public void config(String method, String messageType) {

    }

    public void config(String method, String messageType, String namespace) {

        if (method.equals("topic")) {
            this.dataListener = new TopicDataListener();
        }
    }
